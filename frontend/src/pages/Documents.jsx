        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold flex items-center gap-2">
                        <File className="text-blue-500" /> Documents & Forms
                    </h1>
                    <p className="text-gray-500 mt-1">Official forms, syllabus, and university documents.</p>
                </div>
                <div className="relative w-full md:w-auto">
                    ...
                    <input 
                        ...
                        className="w-full md:w-64 pl-10 pr-4 py-2 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 outline-none"
                    />
                </div>
            </div>
            ...
            {loading ? (
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {files.length === 0 ? (
                        <div className="col-span-full text-center p-12 text-gray-500 glass rounded-2xl">No documents found.</div>
                    ) : (
                        files.map(file => (
                            <div key={file.id} className="glass p-5 rounded-2xl flex flex-col justify-between hover:shadow-xl transition-shadow">
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
                                    ...
                                    <div className="flex gap-2">
                                        <a href={file.file_url} target="_blank" rel="noopener noreferrer" className="p-2 text-blue-500 hover:bg-blue-50 rounded-full transition">
                                            <Download size={18} />
                                        </a>
